pipeline {
    ...
    environment {
        ...
        REPOSITORY_NAME  = 'projectaanvraag-frontend'
    }
    ...
    stages {
        ...
        stage('Setup and build') {
            ...
            stages {
                ...
                stage('Build') {
                    steps {
                        sh label: 'Build binaries', script: 'bundle exec rake projectaanvraag-frontend:build'
                    }
                }
                stage('Build artifact') {
                    steps {
                        sh label: 'Build artifact', script: "bundle exec rake projectaanvraag-frontend:build_artifact ARTIFACT_VERSION=${env.ARTIFACT_VERSION}"
